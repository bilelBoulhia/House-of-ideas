...
export default function Footer() {
    return (
        ...
        <footer style={{zIndex:2}} id='ContactUs' className="relative border-gray-800 mt-4  overflow-hidden border-t-[1px]">
            <div
                className="mx-auto w-full px-2 p-1 py-6 lg:py-8">
                <div
                            ...
                            <ul
                                ...
                                <li className="mb-4">
                                    <a
                                        ...
                                        href="https://nextjs.org/" className="hover:underline z-20">Next js</a>
                                </li>
                                <li>
                                    <a

                                        href="https://tailwindcss.com/" className="hover:underline">Tailwind CSS</a>
                                </li>
                            </ul>
                        </div>
                        <div
                            ...
                            <ul
                                ...
                                <li
                                    ...
                                    <a
                                        ...
                                        href="https://github.com/bilelBoulhia"
